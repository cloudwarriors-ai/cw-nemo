...
export const CONTRACT_IDS = {
  ...
  inviteClaim: "invite-claim.schema.json",
  inviteCreate: "invite-create.schema.json",
  inviteCreateResult: "invite-create-result.schema.json",
  inviteClaimResult: "invite-claim-result.schema.json",
  inviteRevoke: "invite-revoke.schema.json",
  ...
  teamBrief: "team-brief.schema.json",
  teamBriefRun: "team-brief-run.schema.json",
  teamBriefSchedule: "team-brief-schedule.schema.json",
  teamBriefScheduleUpsert: "team-brief-schedule-upsert.schema.json",
  ...
  teamProjectListItem: "team-project-list-item.schema.json",
  teamSummary: "team-summary.schema.json",
